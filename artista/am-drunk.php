...
<head>
    ...
    <title>AM DRUNK - Parana Music</title>
    <LINK REL=StyleSheet HREF="../css/icomoon.css"> 
    <LINK REL=StyleSheet HREF="../css/headernav.css">
    <LINK REL=StyleSheet HREF="../css/artista/am-drunk.css">
...
<body>
    ...
    <!-- Banner con video -->
    <div class="banner">
        <img class="img-hide" src="http://partestwebsite.000webhostapp.com/artista/am-drunk.jpg">  
        <div class="items"> 
